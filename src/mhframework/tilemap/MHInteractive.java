...
/********************************************************************
 * This interface is implemented by all objects that live on a tile
 * map and must interact with each other.  It defines a standard set 
 * of methods indicating the different ways that one object can act 
 * upon another.
 * 
...
public interface MHInteractive
{
    ...
    /****************************************************************
     * To be called when an "operate" command is issued to an
     * object.
     *
     * @param actor The actor that originated the "operate"
     *              command.
     */
    public void operate(MHActor actor);
